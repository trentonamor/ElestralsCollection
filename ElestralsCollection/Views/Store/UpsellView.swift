                ...
                ScrollView {
                    VStack {
                        ...
                        VStack {
                            ...
                            FeatureCell(imageName: "bookmark", imageColor: Color(.dynamicPurple), featureTitle: "Unlimited Bookmark Folders", featureDescription: "Break free from limitations and unleash your creativity with unlimited folder creation in Caster Companion! Perfect for avid players looking to craft and organize countless decks with ease.")
                            FeatureCell(imageName: "paintbrush", imageColor: Color(.dynamicLime), featureTitle: "App Icon Customization", featureDescription: "Unleash your personal style with Caster Companion's customizable icons! Dive into a diverse selection and make the app truly yours.")
                            FeatureCell(imageName: "doc.text", imageColor: Color(.dynamicOrange), featureTitle: "Ascend into the Real World", featureDescription: "Unleash the full potential of your decks beyond Caster Companion. Seamlessly export them in JSON format and integrate them anywhere you desire!")
                            FeatureCell(imageName: "atom", imageColor: Color(.dynamicRed), featureTitle: "Experimental Features", featureDescription: "Unlock exclusive early access with Caster Companion! By joining, you secure a front-row seat to our future enhancements. Await the release of innovative features like Dark Mode, Push Notifications, CSV Exports, Intelligent Bookmarking, and many others. It's a promise of what's to come, all for our dedicated members!")
